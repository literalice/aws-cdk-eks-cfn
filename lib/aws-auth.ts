...
export class AwsAuth extends Construct {
  ...
  private readonly roleMappings = new Array<{ role: iam.IRole, mapping: eks.AwsAuthMapping }>();
  private readonly userMappings = new Array<{ user: iam.IUser, mapping: eks.AwsAuthMapping }>();
   ...
   */
  public addRoleMapping(role: iam.IRole, mapping: eks.AwsAuthMapping) {
   ...
   * @param mapping Mapping to k8s user name and groups
   */
  public addUserMapping(user: iam.IUser, mapping: eks.AwsAuthMapping) {
